...
import { Users, MessageSquare, Send, Plus, Search, LogOut, Hash, User } from 'lucide-react';
...
export default function Collaboration() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            await addMessage(roomId, currentMsg, username);
            fetchMessages();
        } catch (error) {
            console.error(error);
        }
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        {!isMe && <div style={{ fontSize: '0.7rem', fontWeight: 700, color: '#94a3b8', marginBottom: '4px' }}>{msg.user}</div>}
                                        <div style={{
                                            fontSize: '0.95rem',
