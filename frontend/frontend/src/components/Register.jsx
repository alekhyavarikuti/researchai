    ...
    return (
        <div style={{ height: '200px', position: 'relative' }}>
            <AnimatePresence mode='wait'>
                ...
                >
                    <h1 style={{ fontSize: '3.5rem', fontWeight: 700, lineHeight: 1.1, marginBottom: '1.5rem', background: 'linear-gradient(to right, #fff, #94a3b8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', maxWidth: '800px', minHeight: '120px' }}>
                        <TypingText text={texts[index].title} />
                    </h1>
                    <p style={{ fontSize: '1.125rem', color: '#94a3b8', maxWidth: '600px', lineHeight: 1.6 }}>
